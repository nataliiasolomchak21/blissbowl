"""
Django settings for blissbowl project.
...
WSGI_APPLICATION = "blissbowl.wsgi.application"
...
DATABASES = {
    "default": dj_database_url(
        os.environ.get("DATABASE_URL"), conn_max_age=600, options={"timezone": "UTC"}
    ),
}
...
DEFAULT_FROM_EMAIL = "blissbowl@example.com"
